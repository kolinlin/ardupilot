...
//INS choices:
#define HAL_INS_DEFAULT HAL_INS_INV2_SPI
...
// #define HAL_INS_MPU9250_NAME "mpu9250"z`
...
// #define HAL_MAG_PROBE_LIST PROBE_MAG_IMU(AK09916, ICM20948, 0, ROTATION_NONE)
// #define HAL_MAG_PROBE_LIST do{ PROBE_MAG_IMU(AK09916, ICM20948, 0, ROTATION_YAW_90);PROBE_MAG_I2C(IST8310,0,0x0E,true,ROTATION_NONE);}while(0);
...
// #define AP_ARMING_CHECK_DEFAULT (29630)
// #define HAL_AHRS_EKF_TYPE_DEFAULT (0)
#define HAL_BATT_MONITOR_DEFAULT (4)
#define HAL_BATT_VOLT_PIN (34)
#define HAL_BATT_CURR_PIN (35)
#define HAL_BATT_VOLT_SCALE (1.62)
#define HAL_BATT_CURR_SCALE (0.0322)

// no airspeed sensor
// #define AP_COMPASS_ENABLE_DEFAULT 0
// #define ALLOW_ARM_NO_COMPASS
#define AP_AIRSPEED_PIN_DEFAULT (65)
#define AP_AIRSPEED_TYPE_DEFAULT (1)
#define AP_AIRSPEED_MS4525_ENABLED 1
#define AP_AIRSPEED_ENABLED 1
#define AP_AIRSPEED_USE_DEFAULT 1
...
#define WIFI_SSID "NAT-SOE-%02X%02X%02X"
#define WIFI_PWD "minaunghlaing"
...
#define HAL_ESP32_SPI_DEVICES \
    ...
    {.name="icm20948", .bus=0, .device=1, .cs=GPIO_NUM_5,  .mode = 3, .lspeed=2*MHZ, .hspeed=8*MHZ}
//#define HAL_ESP32_SPI_DEVICES {}
...
// #define HAL_ESP32_SDSPI {.host=HSPI_HOST, .dma_ch=1, .mosi=GPIO_NUM_2, .miso=GPIO_NUM_15, .sclk=GPIO_NUM_14, .cs=GPIO_NUM_21}
